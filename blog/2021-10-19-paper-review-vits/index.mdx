...
<!-- ![alignment](./image/mas.png){: style={{width: 600px;}} .center-image} -->
...
6. Donahue, Jeff, et al. "End-to-end adversarial text-to-speech." *arXiv preprint arXiv:2006.03575* (2020). [[arxiv]](https://arxiv.org/abs/2006.03575)
