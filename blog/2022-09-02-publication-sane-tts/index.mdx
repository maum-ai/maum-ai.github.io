...
따라서 metric 하나를 측정하기 위해 1200개 평점의 평균을 구했고 95% 신뢰구간을 계산했습니다.
...
| :---------------------------------------------------------- |
| **Figure 3**: Alignments and mel spectrograms of the speech generated by models with DDP and SDP. The text of the speech is “What was the good of living, and why should he live now?” and the speaker is KSS. The model with DDP generates (a) alignment and (b) mel spectrogram. In extreme cases, model with SDP generates (c) alignment and (d) mel spectrogram with overlong silence. |
